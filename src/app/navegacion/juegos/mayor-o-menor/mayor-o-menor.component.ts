...
export class MayorOMenorComponent implements OnInit {
  ...
  public cartaSacada: {palo: string, numeroCarta: number};
  public cartaAnterior: {palo: string, numeroCarta: number};

  public mensajeCarta: string;

  private mensajesBuenos = ['Xelente!','Eso estuvo cerca!','izi','ez','ggwp','Safaste!','Bien!','Adentrooooo'];
  ...
  public gameOver(){
    ...
    this.habilitarBotonesJuego(false);
    this.puntajeService.registrarPuntaje('Mayor o menor', this.correoJugador, this.puntaje);
