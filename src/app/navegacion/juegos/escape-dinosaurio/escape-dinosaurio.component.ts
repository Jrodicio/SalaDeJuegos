...
@Component({
  selector: 'app-escape-dinosaurio',
  templateUrl: './escape-dinosaurio.component.html',
  styleUrls: ['./escape-dinosaurio.component.scss']
})
export class EscapeDinosaurioComponent implements OnInit {
  ...
  public dinoPosX = 42;
  public dinoPosY: number;

  //Suelo y escenario
  public sueloX: number;
  public sueloLeft: number;
